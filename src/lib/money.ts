/** Money = integer cents everywhere (schema convention). These functions are
 *  the ONLY string/number↔cents boundary; nothing else touches floats. */
...
/** cents → a real decimal number (45.9), for spreadsheet cells that must stay
 *  numeric — the inverse of toCents. Not for display; use formatCents for that. */
